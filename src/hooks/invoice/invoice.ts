...
export const useAddInvoice = () => {
    ...
    return useMutation({
        ...
        onSuccess: (response) => handleMutationSuccess(response, toast, queryClient, ['invoices']),
...
export const useEditInvoice = () => {
    ...
    return useMutation({
        mutationFn: ({ invoiceId, invoiceData }: { invoiceId: number; invoiceData: Partial<InvoicePayload> }) =>
