...
const AddCustomerModal: React.FC<{
  ...
  const { data: flatsResponse, refetch: refetchFlats } = useFilteredFlats(projectId);
  ...
  const { register, handleSubmit, reset, control, setValue, formState: { errors } } = useForm<FormInputs>({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px] md:max-w-[550px] lg:max-w-[650px] w-full">
        <DialogHeader>
          <DialogTitle className="text-xl sm:text-2xl font-bold">Add Customer</DialogTitle>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1 sm:space-y-2">
                <Label htmlFor="flatId" className="text-xs sm:text-sm font-semibold">
                ...
                <Popover open={flatOpen} onOpenChange={setFlatOpen}>
                  <PopoverTrigger asChild>
                    ...
                    >
                      {selectedFlat ?
                        `${selectedFlat.flat_no}, ${selectedFlat.floor?.name || ''} ${selectedFlat.floor?.wing?.tower?.tower_name || ''}`
                        : "Select a flat..."}
                          ...
                          {unoccupiedFlats.map((flat) => (
                            ...
                            >
                              <Check
                                className={cn(
                                  "mr-2 h-4 w-4",
                                  selectedFlat?.id === flat.id ? "opacity-100" : "opacity-0"
                                )}
                              />
              ...
              {selectedFlat && (
                <div className="space-y-1 sm:space-y-2">
                  <Label htmlFor="meter_id" className="text-xs sm:text-sm font-semibold">
                    Meter ID {!selectedFlat.meter && <span className="text-red-500">*</span>}
                  </Label>
                  {selectedFlat.meter ? (
                    <Input
                      id="meter_id"
              ...
              {(selectedFlat?.meter || selectedMeterId) && (
                <div className="space-y-1 sm:space-y-2">
                  <Label htmlFor="previous_reading" className="text-xs sm:text-sm font-semibold">
                  ...
                  {errors.previous_reading && (
                    <p className="text-red-500 text-xs mt-1">{errors.previous_reading.message}</p>
                  )}
                </div>
              )}
              ...
              {/* Approve checkbox */}
              <div className="space-y-1 sm:space-y-2">
                <Label htmlFor="approve" className="text-xs sm:text-sm font-semibold">
